...
//				result = rs.getInt("count(*)");
	...
	public int boardReply(BoardBean board) {
		...
		try {
			...
			String sql="update jspmodel2 set board_re_seq=board_re_seq+1 where board_re_ref=? and board_re_seq > ?";
			...
			sql = "insert into jspmodel2 values(jspmodel2_seq.nextval,?,?,?,?,?,?,?,?,?,sysdate)";
	...
	public int delete(int board_num) {
		...
		try {
			...
			String sql="delete from jspmodel2 where board_num=?";
